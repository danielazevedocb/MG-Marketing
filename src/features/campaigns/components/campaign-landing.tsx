// Landing page pública da campanha — layout "blog": explicação em cima,
// vídeo/fotos em sequência abaixo. Server Component; imagens usam ilhas
// client para fallback.
